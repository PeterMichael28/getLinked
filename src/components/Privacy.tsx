  ...
  <section className="max-w-[1100px] mx-auto w-full grid grid-cols-1 md:grid-cols-2 max-sm:px-6 px-10 max-sm:pt-10 py-16 gap-x-16 gap-y-16 place-content-between md:pt-28 relative ">
   ...
   <div className="w-full text-left max-sm:px-7">
    ...
    <div className="md:text-left text-center flex flex-col md:items-start items-center max-sm:mt-7  relative">
     <h2 className="text-[1.3rem] font-bold text-white leading-none md:text-[1.9rem] tracking-tight">
      Privacy policy and
     </h2>
     <h2 className="text-[1.3rem] font-bold text-tertiary leading-none md:text-[1.9rem] mt-3 md:mt-1">
      Terms
     </h2>
     <span className="text-[.7rem] font-normal text-[rgba(255,255,255,0.6)] mt-4">
      Last updated on September 12, 2023
     </span>
     <p className="text-[.75rem] max-sm:leading-6 text-white mt-8 md:mt-10 md:max-w-[80%]">
     ...
     <img
      src={colorStar}
      alt="star-icon"
      className="absolute w-2 md:w-4 md:right-0 right-14 top-[4%] animate-pulse"
     />
    </div>

    {/* blurry container */}
    <div className="w-full border border-tertiary rounded-md bg-[rgba(217,217,217,0.04)] px-6 py-10 md:p-16 mt-10 md:mt-16">
     <p className="md:text-[.7rem] text-[.75rem] text-white leading-[25px] md:leading-5 text-center md:text-left">
     ...
     <p className="text-[.7rem] font-bold text-tertiary mt-8">
      Licensing Policy
     </p>
     <p className="text-[.7rem] font-bold text-white mt-2">
      Here are terms of our Standard License:
     </p>
     <ul className="flex flex-col gap-y-5 items-start mt-7 text-[.7rem] mb-7">
      <li className="flex gap-x-3 items-start justify-start">
       {" "}
       <img
        src={listcheck}
        alt="check icon"
