...
const Judging = () => {
  return (
    <section className=" md:pt-3 mt-16 relative border-b border-zinc-700 py-2 pb-10 md:pb-24">
        ...
        {/* first blur */}
    <div className="w-full md:w-[70rem] md:h-[40rem] h-[70vh] bg-no-repeat bg-contain bg-right bg-bgBlur absolute -left-[7rem] -top-[8rem] md:top-[6rem] md:-left-[30rem] mix-blend-hard-light opacity-[1] blur-xl"></div>

{/* second blur */}
<div className="w-full md:w-[70rem] md:h-[40rem] h-[70vh] bg-no-repeat bg-contain bg-right bg-bgBlur absolute left-[9rem] -bottom-[20%] md:top-[20rem] md:left-[50%] mix-blend-hard-light opacity-[1] blur-xl"></div>
