...
{/* second blur */}
<div className="w-full md:w-[80rem] md:h-[40rem] h-[70vh] bg-no-repeat bg-contain bg-right bg-bgBlur absolute left-[9rem] -bottom-[20%] md:top-[20rem] md:left-[32%] mix-blend-hard-light opacity-[1] blur-xl"></div>
<img src={whiteStar} alt="star-icon" className="absolute w-2 md:w-3  right-10 bottom-16 md:top-[15rem] md:left-[50%] animate-pulse"/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 place-items-center place-content-center gap-7 gap-y-7 max-w-[1100px] mx-auto relative ">
              ...
              {/* colored star */}
        <img src={colorStar} alt="star-icon" className="absolute w-3 left-12 top-[30%] animate-pulse"/>
        <img src={whiteStar} alt="star-icon" className="absolute w-2 md:w-3  left-[50%] top-[50%] animate-pulse"/>
        ...
        <div className="md:text-left text-center flex flex-col md:items-start items-center max-sm:px-14 relative">
              <h2 className="text-[1.3rem] font-bold text-white leading-none md:text-[1.9rem]">Judging Criteria</h2>
              <h2 className="text-[1.3rem] font-bold text-tertiary leading-none md:text-[1.9rem] mt-3 md:mt-3">Key attributes</h2>
