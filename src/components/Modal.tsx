...
const Modal = ({ active, children }: ModalProps) => {
 return (
  ...
  >
   <div
    className={`max-w-[600px] w-full border border-tertiary bg-rgba(255,255,255,0.01)] rounded-[.3rem] p-3 py-6 md:py-8 md:px-7 lg:px-16  transition-all duration-300 ${
     active ? "scale-100" : "scale-0"
    } origin-center delay-200`}
   >
    {children}
   </div>
  </section>
